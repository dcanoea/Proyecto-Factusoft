...
public class InvoiceHelpers {
    ...
    // <editor-fold desc="Variables y constantes">
    public static final String invoiceSeries = "R2025";// Obligatorio en facturas rectificativas
    // </editor-fold>
    ...
    public static JSONObject createGlobalDiscount(String iva, String quantity, String unitAmount) {
        ...
        JSONObject system = setSystem(category);
    ...
    // <editor-fold desc="Creación objetos JSON">
    public static JSONObject setBody(JSONObject content) throws JSONException {
        // ========= JSON BODY ==========
    ...
    public static JSONObject setCategory(String ivaRate) throws JSONException {
        // Tipo IVA
        JSONObject category = new JSONObject();
    ...
    public static JSONObject setContent(JSONArray recipients, JSONObject data) throws JSONException {
        // ========= CONTENT =========
    ...
    public static JSONObject setContentCorrectingDifFerences(String invoiceNumber, JSONObject invoice) throws JSONException {
        // ======== CONTENIDO PRINCIPAL =========
        JSONObject content = new JSONObject();
        ...
        content.put("code", "CORRECTION_1"); //RECTIFICACION BASADO ART. 80, APARTADOS 1, 2 Y 6.
        //content.put("code", "CORRECTION_2"); //RECTIFICACION BASADO ART. 80, APARTADO 3.
        //content.put("code", "CORRECTION_3"); //RECTIFICACION BASADO ART. 80, APARTADO 4.
        //content.put("code", "CORRECTION_4"); //RECTIFICACION FACTURA POR OTRAS RAZONES (ERRORES ADMINISTRATIVOS...)
        return content;
    }

    public static JSONObject setContentCorrectingSubstitution(String invoiceNumber, JSONObject invoice) throws JSONException {
        // ======== CONTENIDO PRINCIPAL =========
        JSONObject content = new JSONObject();
        content.put("type", "CORRECTING");
    ...
    public static JSONObject setDataCompleteInvoice(String invoiceNumber, JSONArray items, String fullAmountTotal) throws JSONException {
        // ========= DATA =========
    ...
    public static JSONObject setDataCorrectingInvoice(String invoiceNumber, JSONArray items, String fullAmountTotal) throws JSONException {
        // ======== SUBOBJETO DATA =========
        JSONObject data = new JSONObject();
    ...
    public static double setGlobalDiscounts(List<JSONObject> globalDiscounts, JSONArray items, double totalAmount) throws JSONException {
        // Descuentos globales
    ...
    public static JSONObject setInvoice(JSONObject data, JSONArray recipients) throws JSONException {
        // ======== OBJETO INVOICE =========
    ...
    public static double setItem(JSONObject itemData, JSONArray items) throws JSONException {
        ...
        JSONObject category = InvoiceHelpers.setCategory(ivaRate);
        JSONObject system = setSystem(category);
    ...
    public static JSONArray setRecipient(Map<String, String> receptorDetails) throws JSONException {
        // ========= RECEPTOR =========
    ...
    public static double setSuppliedItems(List<JSONObject> suppliedItems, JSONArray items, double totalAmount) throws JSONException {
        // Ítems suplidos
    ...
    public static JSONObject setSystem(JSONObject category) throws JSONException {
        // Régimen Fiscal
    ...
    // <editor-fold desc="Comunicación con API">
